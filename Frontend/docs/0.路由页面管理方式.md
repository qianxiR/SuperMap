...
└── /dashboard/traditional/intersect (叠置分析)
```
...
- **工具面板位置**: `src/views/dashboard/traditional/tools/`
  ...
  - `intersectAnalysisPanel.vue` → 叠置分析
...
└── /dashboard/traditional/intersect (叠置分析) → src/views/dashboard/traditional/tools/intersectAnalysisPanel.vue
```
...
└─────────────────────────────────────────────────────────────────┘
        ...
        ChatAssistant.vue                              ┌─────┼─────┐
                                                       │     │     │
                                              /layer  /attribute-selection /area-selection /buffer /distance /intersect
                                                │       │      │      │        │        │
                                        layermanager FeatureQuery EditTools BufferAnalysis DistanceAnalysis intersectAnalysis
```
...
| `/dashboard/traditional/intersect` | 叠置分析 | `src/views/dashboard/traditional/tools/intersectAnalysisPanel.vue` | 空间叠置分析 |
...
const toolConfigs = {
  ...
  intersect: { id: 'intersect', title: '叠置分析', path: 'intersect' },
