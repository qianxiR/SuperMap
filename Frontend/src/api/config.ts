...
const analysisServiceConfigs: Record<string, APIConfig> = {
  development: {
    baseUrl: `${import.meta.env.VITE_ANALYSIS_SERVICE_BASE_URL || 'https://f8caaa970a74.ngrok-free.app'}${import.meta.env.VITE_ANALYSIS_SERVICE_API_PREFIX || '/api/v1/spatial-analysis'}`,
